...
router.get("/", async (req, res) => {
  ...
  // This destroys asteroids older than 14 hours in the database
   ...
   // This pulls in asteroid data from NASA
  const nasaData = await axios.get(`https://api.nasa.gov/neo/rest/v1/feed?start_date=${today}&api_key=m3HKKEeMd83xzbasILLhUhnjvaYnkqmbJVmfOMuU`);
